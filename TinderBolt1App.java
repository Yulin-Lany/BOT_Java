...
public class TinderBoltApp extends MultiSessionTelegramBot {
    public static final String TELEGRAM_BOT_NAME = "Test_..._Bot"; //TODO: добавь имя бота в кавычках
    public static final String TELEGRAM_BOT_TOKEN = "7...A"; //TODO: добавь токен бота в кавычках
    public static final String OPEN_AI_TOKEN = "DELL"; //TODO: добавь токен ChatGPT в кавычках
...
// PROFILE
        if (message.equals("/profile")) {
            ...
            me = new UserInfo();
            questionCount = 1;
            sendTextButtonsMessage("Сколько лет?");
            return;
        }
